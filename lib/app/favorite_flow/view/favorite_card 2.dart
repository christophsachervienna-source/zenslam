...
class _FavoriteCardState extends State<FavoriteCard>
  ...
  Widget _buildBackgroundImage() {
    return CachedNetworkImage(
      imageUrl: widget.item.item.thumbnail,
      fit: BoxFit.cover,
  ...
  Widget _buildContent() {
    final formattedDuration = _formatDuration(widget.item.item.duration);
            ...
            children: [
              ...
              Obx(() {
                ...
                final isThisAudioPlaying =
                    ...
                    currentPlayingId == widget.item.item.id &&
  ...
  Widget _buildFavoriteButton() {
    return Positioned(
      ...
      child: GestureDetector(
        onTap: () {
          favoriteController.addFavorites(widget.item.item.id);
        },
        child: Obx(() {
          final isFavorite =
              favoriteController.isItemInFavorites(widget.item.item.id);
