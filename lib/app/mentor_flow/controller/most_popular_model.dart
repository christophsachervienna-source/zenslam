...
class MostPopularModel {
  ...
  factory MostPopularModel.empty() {
    return MostPopularModel(
      id: '',
      contentType: [],
      accessType: 'FREE',
  ...
  @override
  String toString() {
    return 'MostPopularModel(id: $id, title: $title, contentType: $contentType, mostPopular: $mostPopular)';
  }
}
...
class MostPopularResponse {
  ...
  factory MostPopularResponse.fromJson(Map<String, dynamic> json) {
    return MostPopularResponse(
      ...
      data: MostPopularData.fromJson(json['data'] ?? {}),
    );
  }
}
...
class MostPopularData {
  final Meta meta;
  final List<MostPopularModel> data;
  final bool hasMore;
  ...
  factory MostPopularData.fromJson(Map<String, dynamic> json) {
    ...
    final dataList = (json['data'] as List<dynamic>?)
            ?.map((item) => MostPopularModel.fromJson(item))
            .toList() ??
        [];
