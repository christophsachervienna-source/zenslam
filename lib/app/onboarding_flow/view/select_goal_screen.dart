                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Obx(() {
                            ...
                            return GestureDetector(
                              onTap: () =>
                                  controller.toggleGoal(want.name, want.image),
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    (want.image.startsWith('http') ||
                                            want.image.startsWith('https'))
                                        ? Image.network(
                                            want.image,
                                            height: 24,
                                            width: 24,
                ...
                Padding(
                  ...
                  child: Obx(() {
                    ...
                    return CustomButton(
                      ...
                      onTap: isEnabled
                          ? () async {
                              ...
                              if (isFromPreference) {
                                ...
                                await SharedPrefHelper.saveIsOnboardingCompleted(
                                  true,
                                );
                      ...
                      textColor: isEnabled ? Colors.black : Colors.white,
                    );
                  }),
                ),
