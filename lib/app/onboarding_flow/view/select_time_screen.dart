...
import 'package:zenslam/app/profile_flow/widgets/select_most_important_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: must_be_immutable
class SelectTimeScreen extends StatelessWidget {
  SelectTimeScreen({super.key, this.isFromPreference = false});
  final bool isFromPreference;

  SelectTimeController controller = Get.put(SelectTimeController());
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "How much time do you have to commit to practice?",
                          ...
                          return Obx(() {
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    // Display emoji or image before text
                                    if (time.image.isNotEmpty) ...[
                                      if (time.image.startsWith('http') ||
                                          time.image.startsWith('https'))
                                        Image.network(
                                          time.image,
                                          height: 24,
                                          width: 24,
                                      ...
                                      else if (!time.image.contains(
                                            'assets/',
                                          ) &&
                                          !time.image.contains('.png'))
                                        // It's an emoji
                                        Text(
                                          time.image,
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 24.0),
                  child: Obx(() {
                    final selected = controller.timeModel.value.selectedTimes;
                    return CustomButton(
                      ...
                      onTap: selected.isEmpty
                          ...
                          : () {
                              debugPrint(
                                "Selected Times ⏳: ${selected.toList()}",
                              );
                              if (isFromPreference) {
                                Get.back(result: true);
                              } else {
                                Get.to(() => SelectMostImportantScreen());
                              }
                            },
                    );
                  }),
