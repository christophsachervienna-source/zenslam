...
class MasterClassModel {
  ...
  factory MasterClassModel.empty() {
    return MasterClassModel(
      id: '',
      contentType: [],
      accessType: 'FREE',
  ...
  @override
  String toString() {
    return 'MasterClassModel(id: $id, title: $title, contentType: $contentType, masterClass: $masterClass)';
  }
}

// Update MasterClassResponse to include hasMore
class MasterClassResponse {
  final bool success;
  final String message;
  final MasterClassData data;
  ...
  factory MasterClassResponse.fromJson(Map<String, dynamic> json) {
    return MasterClassResponse(
      success: json['success'] ?? false,
      message: json['message'] ?? '',
      data: MasterClassData.fromJson(json['data'] ?? {}),
    );
  }
}

// Update MasterClassData to include hasMore
class MasterClassData {
  final Meta meta;
  final List<MasterClassModel> data;
  final bool hasMore;
  ...
  factory MasterClassData.fromJson(Map<String, dynamic> json) {
    final meta = Meta.fromJson(json['meta'] ?? {});
    final dataList = (json['data'] as List<dynamic>?)
            ?.map((item) => MasterClassModel.fromJson(item))
            .toList() ??
        [];
